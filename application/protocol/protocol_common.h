...
#define PROTOCOL_BROADCAST_ADDR (0xFF)  //协议广播地址
...
typedef struct
{
  ...
  struct rcv_cmd_info rcv_cmd_info[PROTOCOL_CMD_MAX_NUM];
  struct send_cmd_info send_cmd_info[PROTOCOL_CMD_MAX_NUM];
